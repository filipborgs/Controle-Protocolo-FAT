...
(
	id				INTEGER NOT NULL DEFAULT NEXTVAL('id_usuario'::regclass),
...
(
    ...
    CONSTRAINT fk_protocolo_id FOREIGN KEY (n_protocolo) REFERENCES protocolo (id) MATCH SIMPLE ON UPDATE RESTRICT ON DELETE RESTRICT,
    CONSTRAINT fk_movimentacao_id_usuario FOREIGN KEY (id_usuario_movimentacao) REFERENCES usuario (id) MATCH SIMPLE ON UPDATE RESTRICT ON DELETE RESTRICT
);